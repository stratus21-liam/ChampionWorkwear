<!--banner-->
<div class="dz-bnr-inr style-1" style="background-image:url( <% if SiteConfig.BannerImage %> $SiteConfig.BannerImage.URL <% else %>$themedResourceURL('theme/images/background/bg-shape.jpg') <% end_if %>);">
   <div class="container">
...
<% with CurrentMember.CustomerAccount %>
   <section class="content-inner-1 z-index-unset">
      <div class="container">
         <div class="row m-auto gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3" id="product-grid">
            <% loop VisibleProducts %>
               <div class="col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-sm-b0 m-b30 product-pagination-item">
                  <div class="shop-card">
                     <div class="dz-media">
                        <img src="$FeaturedImage.URL" alt="image">			
                        <div class="shop-meta">
                           <% if Active %>
         ...
         <div class="row page mt-0 align-items-center">
            <div class="col-md-6">
               <p class="page-text mb-md-0" id="product-pagination-status">Showing 0 of 0 Results</p>
            </div>
               ...
               <nav aria-label="Product Pagination">
                  <ul class="pagination style-1 justify-content-md-end justify-content-start mb-0">
                     <li class="page-item" id="load-more-products-wrap">
                        <a class="page-link next" href="javascript:void(0);" id="load-more-products">Load More</a>
                     </li>
                  </ul>
               </nav>
            </div>
